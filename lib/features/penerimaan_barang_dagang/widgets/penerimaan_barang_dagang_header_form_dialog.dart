// lib/features/penerimaan_barang_dagang/widgets/penerimaan_barang_dagang_header_form_dialog.dart
//
// Dialog header penerimaan barang dagang — hanya memilih tanggal. Tim sudah
// diketahui dari kartu yang di-tap. Tombol SIMPAN langsung hit createHeader
...
class PenerimaanBarangDagangCreateDialog extends StatefulWidget {
  final TimPenerimaanInfo tim;

  const PenerimaanBarangDagangCreateDialog({super.key, required this.tim});

  @override
  State<PenerimaanBarangDagangCreateDialog> createState() =>
      _PenerimaanBarangDagangCreateDialogState();
}

class _PenerimaanBarangDagangCreateDialogState
    extends State<PenerimaanBarangDagangCreateDialog> {
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      '${widget.tim.namaTim} — Penerimaan Barang Dagang',
