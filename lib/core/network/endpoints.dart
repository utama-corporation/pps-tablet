...
class ApiConstants {
  ...
  static String barangDagangLabelPdf(String noBarangDagang) {
    final host = Uri.parse(baseUrl).host;
    final encoded = Uri.encodeComponent(noBarangDagang);
    return 'http://$host:7500/api/labels/barang-dagang/$encoded/pdf/';
  }
